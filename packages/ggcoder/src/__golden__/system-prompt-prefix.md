...
}
{
  ...
  "input_schema": {
    ...
    "properties": {
      ...
      "timeout": {
        "description": "Optional foreground timeout in milliseconds; omit for no deadline (also with persist:true). Finite build, test, lint, format, migration, and one-shot commands wait for completion in foreground.",
        "type": "integer",
        "minimum": 1000,
        "maximum": 9007199254740991
      },
