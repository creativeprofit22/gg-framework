...
export const LOCAL_UPDATE_CONFIRMATION_MESSAGE =
  "This will rebase custom/local-customizations-v2 on upstream/main, preserve backups and stashed work, then build a patched installer. It will not install the official binary.";
