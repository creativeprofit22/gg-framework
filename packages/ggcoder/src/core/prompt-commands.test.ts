...
describe("prompt commands", () => {
  ...
  it("prompt contract: requires deterministic normalized rendering and idempotent reruns", () => {
    const prompt = getPromptCommand("setup-tauri-package")!.prompt;
    ...
    expect(prompt).toContain("same-evidence rerun must render byte-identical support files");
