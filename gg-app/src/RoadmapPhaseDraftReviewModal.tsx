...
export function RoadmapPhaseDraftReviewModal({
  ...
  return (
    <section
      className="roadmap-draft-review"
      aria-label="Review Roadmap draft"
      aria-busy={deciding}
    >
      <div
        className="review-content-scroller"
        tabIndex={0}
        role="region"
        aria-label="Roadmap draft content"
      >
      ...
      <div className="roadmap-draft-actions review-reading-rail">
        <button
          type="button"
