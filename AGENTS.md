...
- Treat release-note upkeep as part of finishing a user-facing Local Fork change; do it without a separate reminder. Skip internal-only refactors, tests, tooling, and documentation changes unless they change something users experience.
