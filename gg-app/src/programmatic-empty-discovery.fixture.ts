...
export function emptyDiscoveryAssessment(inspected: boolean): ProgrammaticAssessment {
  return {
    version: 1, mode: "configured", status: "completed",
    summary: "Bounded needs assessment completed; recommendations are advisory.",
    limitations: inspected ? ["Only the two static documentation files were inspected."]
      : ["All six source reads were denied; workflows and recurrence cannot be established."],
    coverage: [
      { scope: "project", status: "uninspected", summary: "Project-wide coverage is not established." },
      { scope: "project", status: inspected ? "inspected" : "uninspected", summary: inspected
      ...
      { scope: "catalog", status: "inspected", summary: "Catalog inspection does not establish project coverage." },
    ],
    observations: [], deterministic: { status: "succeeded", enabledCount: 1, applicableCount: 1 },
