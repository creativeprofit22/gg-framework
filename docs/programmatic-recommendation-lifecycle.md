...
The existing Opportunities rows and selection remain deterministic. This work does not add recommendation cards/buttons, a new dashboard, or a native UI campaign.
